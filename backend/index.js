...
// Schedule the task to run every minute (change as needed)
cron.schedule('* * * * *', async () => {
  try {
...
const sellerUsername = productDetails.userId.username;
      ...
      // Optional: Update the product status to indicate that emails have been sent
...
app.post('/api/reportUser/:userId', async (req, res) => {
 ...
 // Assuming you have defined your user schema and have access to User model
// You need to implement these routes in your backend
